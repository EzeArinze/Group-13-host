...
// function MusicPage({ setPlaylist }) {
...
//       {(search || genre) && (
//         <MusicList music={music} addToPlaylist={addToPlaylist} />
//       )}
...
// function MusicList({ music, addToPlaylist }) {
//   return (
...
// function Track({ item, addToPlaylist }) {
...
//         </div>
//         <FaPlus onClick={() => addToPlaylist(item)} className="add-button" />
//       </li>
//     </div>
//   );
// }
